...
public class Key
{
    public const string PACK1 = "game66_pack1";
    public const string PACK2 = "game66_pack2";
    public const string PACK3 = "game66_pack3";
    public const string PACK4 = "game66_pack4";
    public const string PACK5 = "game66_pack5";
    public const string PACK6 = "game66_pack6";


    public const string PACK1_REGISTER = "register_game66_pack1";
    public const string PACK2_REGISTER = "register_game66_pack2";
    public const string PACK3_REGISTER = "register_game66_pack3";
    public const string PACK4_REGISTER = "register_game66_pack4";
